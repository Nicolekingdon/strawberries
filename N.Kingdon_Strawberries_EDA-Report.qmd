...
strwb_survey_chem <- strwb_survey_chem |>
  mutate(toxicity = case_when(
    ...
    chemical %in% c("COPPER ETHANOLAMINE", "KANTOR", "HALOSULFURON-METHYL") ~ "Unknown",
    TRUE ~ "Bacteria"  
  ))
```
...
ggplot(data = filtered_data2,
  ...
  geom_text(aes(label = Value), vjust = -0.5, position = position_dodge(width = 0.9)) +
  labs(
    title = "Figure 4. States* and Organic Strawberry Sales in US Dollars",
    x = "Year",
    y = "Sales ($ in 1000s)",
    caption = "*California was excluded due to extremely higher sales"
  ) +
...
ggplot(data = filtered_data3,
  ...
  geom_bar(stat = "identity", position = "dodge") +
  labs(
    title = "Figure 5. California* and Organic Strawberry Sales in US Dollars",
    x = "Year",
    y = "Sales ($ in 100000s)",
...
ggplot(data = filtered_data5,
  ...
  geom_text(aes(label = Value), vjust = -0.5, position = position_dodge(width = 0.9)) +
  labs(
    title = "Figure 6. States* and Organic Strawberry Sales in US Dollars",
    x = "Year",
...
ggplot(data = filtered_data6,
  ...
  geom_bar(stat = "identity", position = "dodge") +
  labs(
    title = "Figure 7. California* and Organic Strawberry Sales in US Dollars",
    x = "Year",
...
As shown in Figure 8 below, California used all four fertilizers on their crops (nitrogen, phosphate, potash, sulfur), and Florida used all but sulfur. The fertilizer used the most was nitrogen for both California (n = 16.9) and Florida (n = 28.7). Next most used was potash for both California (n = 14.3) and Florida (n = 25.2). Florida used more fertilizer than California for all three fertilizers they both used. Nitrogen and potash were used the most for both California and Florida (n = )
...
ggplot(data = filtered_data10,
       mapping = aes(x = fertilizer_type, y = Value, fill = State)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(
    title = "Figure 8. Calfornia and Florida Fertiziler Usage on Strawberries",
    x = "Fertilizer",
    y = "Average Number of Ferilizer Usage",
...
ggplot(data = filtered_data11,
  ...
  labs(
    title = "Figure 9. Pounds of Fertiziler Used on Strawberries in California",
    x = "Fertilizer",
...
ggplot(data = filtered_data12,
  ...
  labs(
    title = "Figure 10. Pounds of Fertiziler Used on Strawberries in Florida",
    x = "Fertilizer",
    y = "lbs of Fertilizer Used (10000s)",
  ) +
  theme_bw() +
